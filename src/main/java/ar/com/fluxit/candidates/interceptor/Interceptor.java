package ar.com.fluxit.candidates.interceptor;
...
import ar.com.fluxit.candidates.security.JwtValidator;
import constant.ValidatorResult;
import constant.ValidatorResult.ValidatorStatus;
...
public class Interceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		resultHandlers.get(validatorResult.getValidatorStatus()).handle(request, response, neededRoles, validatorResult);
		request.setAttribute("com.example.meetup.jwt.model.JwtUser", validatorResult.getUser());
